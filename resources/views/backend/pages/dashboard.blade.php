                ...
                <table class="table border mb-0">
                  ...
                  <tbody>
                    ...
                    <tr class="align-middle">
                      <td class="text-center">
                        <div class="avatar avatar-md"><img class="avatar-img"
                            src="/back_assets/assets/img/avatars/2.jpg" alt="user@email.com"><span
                    ...
                    <tr class="align-middle">
                      <td class="text-center">
                        <div class="avatar avatar-md"><img class="avatar-img"
                            src="/back_assets/assets/img/avatars/3.jpg" alt="user@email.com"><span
                    ...
                    <tr class="align-middle">
                      <td class="text-center">
                        <div class="avatar avatar-md"><img class="avatar-img"
                            src="/back_assets/assets/img/avatars/4.jpg" alt="user@email.com"><span
                    ...
                    <tr class="align-middle">
                      <td class="text-center">
                        <div class="avatar avatar-md"><img class="avatar-img"
                            src="/back_assets/assets/img/avatars/5.jpg" alt="user@email.com"><span
                            class="avatar-status bg-success"></span></div>
                      </td>
                      <td>
                    ...
                    <tr class="align-middle">
                      <td class="text-center">
                        <div class="avatar avatar-md"><img class="avatar-img"
                            src="/back_assets/assets/img/avatars/6.jpg" alt="user@email.com"><span
                            class="avatar-status bg-danger"></span></div>
                      </td>
                      <td>
